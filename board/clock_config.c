...
- {id: FXCOM6_clock.outFreq, value: 32.768 MHz}
- {id: FXCOM7_clock.outFreq, value: 32.768 MHz}
- {id: HSLSPI_clock.outFreq, value: 150 MHz}
- {id: MCLK_clock.outFreq, value: 32.768 MHz}
...
- {id: ModulationFrequencyConfig, value: '4'}
- {id: SYSCON.CTIMERCLKSEL2.sel, value: SYSCON.MAINCLKSELB}
- {id: SYSCON.FCCLKSEL4.sel, value: ANACTRL.fro_12m_clk}
- {id: SYSCON.FCCLKSEL6.sel, value: SYSCON.PLL0DIV}
- {id: SYSCON.FCCLKSEL7.sel, value: SYSCON.PLL0DIV}
- {id: SYSCON.FRGCTRL6_DIV.scale, value: '256', locked: true}
- {id: SYSCON.FROHFDIV.scale, value: '3', locked: true}
- {id: SYSCON.HSLSPICLKSEL.sel, value: SYSCON.MAINCLKSELB}
- {id: SYSCON.MAINCLKSELB.sel, value: SYSCON.PLL1_BYPASS}
- {id: SYSCON.MCLKCLKSEL.sel, value: SYSCON.PLL0_BYPASS}
- {id: SYSCON.MCLKDIV.scale, value: '1', locked: true}
- {id: SYSCON.PLL0CLKSEL.sel, value: SYSCON.CLK_IN_EN}
- {id: SYSCON.PLL0DIV.scale, value: '1', locked: true}
- {id: SYSCON.PLL0M_MULT.scale, value: '2048', locked: true}
- {id: SYSCON.PLL0N_DIV.scale, value: '100', locked: true}
- {id: SYSCON.PLL0_PDEC.scale, value: '10', locked: true}
...
void BOARD_BootClockPLL100M(void)
{
    ...
    const pll_setup_t pll0Setup = {
        .pllctrl = SYSCON_PLL0CTRL_CLKEN_MASK | SYSCON_PLL0CTRL_SELI(3U) | SYSCON_PLL0CTRL_SELP(31U),
        .pllndec = SYSCON_PLL0NDEC_NDIV(100U),
        .pllpdec = SYSCON_PLL0PDEC_PDIV(5U),
        .pllsscg = {0x0U,(SYSCON_PLL0SSCG1_MDIV_EXT(2048U) | SYSCON_PLL0SSCG1_SEL_EXT_MASK)},
        .pllRate = 32768000U,
    ...
    CLOCK_SetClkDiv(kCLOCK_DivMClk, 1U, false);         /*!< Set MCLKDIV divider to value 1 */
    ...
    CLOCK_AttachClk(kPLL0_DIV_to_FLEXCOMM6);                 /*!< Switch FLEXCOMM6 to PLL0_DIV */
    CLOCK_AttachClk(kPLL0_DIV_to_FLEXCOMM7);                 /*!< Switch FLEXCOMM7 to PLL0_DIV */
    CLOCK_AttachClk(kMAIN_CLK_to_HSLSPI);                 /*!< Switch HSLSPI to MAIN_CLK */
    CLOCK_AttachClk(kPLL0_to_MCLK);                 /*!< Switch MCLK to PLL0 */
